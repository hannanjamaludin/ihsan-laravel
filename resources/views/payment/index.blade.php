    ...
    <div class="col-12">
        ...
        <div class="card mb-4 mx-3">
            <div class="card-header py-1 d-flex flex-row justify-content-between card-header-divider">
                <div class="col">
                    <h5 class="card-title mt-2">Pembayaran Yuran</h5>
                </div>
            </div>
                    ...
                    <div class="mt-3 text-start">
                        @foreach ($students as $s)
                                <div class="card mb-4 mx-3 card-students clickable-card" style="cursor: pointer;" 
                                        data-href="{{ route('pembayaran.yuran_student', ['studentId' => $s->id]) }}">
                                        {{-- data-href="{{ route('pembayaran.buat_pembarayan') }}"> --}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2 pt-2">
                                                <div class="container d-flex align-items-center justify-content-end m-0 pt-1">
                                                    <a href="{{ route('pembayaran.yuran_student', ['studentId' => $s->id]) }}" class="btn btn-link text-decoration-none" style="font-size: 24px;">
                                                    {{-- <a href="{{ route('pembayaran.buat_pembarayan') }}" class="btn btn-link text-decoration-none" style="font-size: 24px;"> --}}
