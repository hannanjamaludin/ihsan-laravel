    ...
    <div class="modal fade" id="modalStudentDetails" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            ...
            <div class="modal-footer">
                {{-- <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="update_application({{$studentId}}, 0)">Tolak Permohonan</button>
                <button type="button" class="btn btn-primary" onclick="update_application({{$studentId}}, 1)">Terima Permohonan</button> --}}
